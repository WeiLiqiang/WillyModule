...
import com.wlq.willymodule.base.business.camera.config.convert.ImageRawDataConverter
...
import com.wlq.willymodule.base.business.camera.util.CameraHelper.getCamcorderProfile
...
class Camera2Manager(cameraPreview: CameraPreview) : BaseCameraManager<String>(cameraPreview), ImageReader.OnImageAvailableListener {
    ...
    private fun adjustCameraConfiguration(forceCalculate: Boolean) {
        ...
        if (videoSize == null || forceCalculate) {
            camcorderProfile = currentCameraId?.let { getCamcorderProfile(expectedQuality, it) }
    ...
    private fun prepareVideoRecorder(): Boolean {
        ...
        try {
            ...
            if (camcorderProfile != null) {
                ...
                e("Camera2Manager", "Failed to initialize video recorder, the camcorder profile was null.")
            }
    ...
    internal abstract class CaptureSessionCallback : CameraCaptureSession.CaptureCallback() {
