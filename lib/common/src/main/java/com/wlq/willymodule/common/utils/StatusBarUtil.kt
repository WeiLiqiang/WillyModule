package com.wlq.willymodule.common.utils
...
object StatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private fun createStatusBarView(activity: Activity, @ColorInt color: Int, @androidx.annotation.IntRange(from = 0, to = 255) alpha: Int): View {
        // 绘制一个和状态栏一样高的矩形
