...
import com.wlq.base_transform.BaseTransformPlugin
import com.wlq.base_transform.util.JsonUtils
...
class ApiPlugin extends BaseTransformPlugin<ApiExtension> {
    ...
    void scanClassFile(File classFile, String className, File originScannedJarOrDir) {
        ...
        ClassVisitor cv = new ApiClassVisitor(mProject, cw, apiImplMap, apiClasses, apiUtilsClass)
        try {
