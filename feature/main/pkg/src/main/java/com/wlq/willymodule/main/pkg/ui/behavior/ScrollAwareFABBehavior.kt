package com.wlq.willymodule.main.pkg.ui.behavior
...
import com.wlq.willymodule.main.pkg.util.AnimatorUtils
...
class ScrollAwareFABBehavior : FloatingActionButton.Behavior {
    ...
    override fun onNestedScroll(coordinatorLayout: CoordinatorLayout, child: FloatingActionButton, target: View, dxConsumed: Int, dyConsumed: Int, dxUnconsumed: Int, dyUnconsumed: Int, type: Int) {
        ...
        if ((dyConsumed > 0 || dyUnconsumed > 0) && !isAnimateIng && isShow) {
            AnimatorUtils.translateHide(child, object : StateListener() {
            ...
            // 手指下滑，显示FAB
            AnimatorUtils.translateShow(child, object : StateListener() {
                override fun onAnimationStart(view: View) {
                    super.onAnimationStart(view)
                    isShow = true
                }
